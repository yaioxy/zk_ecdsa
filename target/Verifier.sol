...
library HonkVerificationKey {
    function loadVerificationKey() internal pure returns (Honk.VerificationKey memory) {
        Honk.VerificationKey memory vk = Honk.VerificationKey({
            ...
            s3: Honk.G1Point({ 
               x: uint256(0x2816d28bc3cc6da3a53965f88d6e25cc9d7459a1ace27e88955383dc00463cad),
               y: uint256(0x0335528e7a7369a92ed1034547d6fa97507c9b2a75ced7278e3badfd2debb761)
            }),
            s4: Honk.G1Point({ 
